    ...
    <>
      ...
      <div className={classes.cardDetails}>
        ...
        <div>
          ...
          <Button className={classes.checkoutButton} component={Link} to="/checkout" size="large" type="button" variant="contained" color="primary">Valider</Button>
        </div>
      </div>
    </>
  );
